...
public class AlertHelper {
    ...
    public static void showInformationDialog(String title, String header, String content) {
        ...
        alert.initModality(Modality.APPLICATION_MODAL); // Block other windows
        // You can get the Stage and set an owner if needed:
        // Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
        // stage.initOwner(ownerStage); // ownerStage would be passed in
        alert.showAndWait();
    }
